...
cat：全拼concatenate，查看或合并文件

```shell
cat  hello.txt   打开文件
cat dd1.txt dd2.txt dd3.txt >> dd.txt 合并多个文件

cat > test.txt << EOF   在控制台中创建文件
>…
>…内容
>…
>EOF  (以EOF结束输入，可自定义）
...
往期汇总：[001期~150期汇总](http://mp.weixin.qq.com/s?__biz=MzIyNDU2ODA4OQ==&mid=2247485351&idx=2&sn=214225ab4345f4d9c562900cb42a52ba&chksm=e80db1d1df7a38c741137246bf020a5f8970f74cd03530ccc4cb2258c1ced68e66e600e9e059&scene=21#wechat_redirect)
